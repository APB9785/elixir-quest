defmodule ElixirQuestWeb.AccountAuthTest do
  use ElixirQuestWeb.ConnCase, async: true

  alias ElixirQuest.Accounts
  alias ElixirQuestWeb.AccountAuth
  import ElixirQuest.AccountsFixtures

  @remember_me_cookie "_elixir_quest_web_account_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ElixirQuestWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_account/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ElixirQuestWeb.Endpoint.subscribe(live_socket_id)
