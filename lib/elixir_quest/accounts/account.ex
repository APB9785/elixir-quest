defmodule ElixirQuest.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ElixirQuest.Repo)
  ...
  """
  def valid_password?(%ElixirQuest.Accounts.Account{hashed_password: hashed_password}, password)
