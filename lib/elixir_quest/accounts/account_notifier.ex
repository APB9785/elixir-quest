defmodule ElixirQuest.Accounts.AccountNotifier do
  import Swoosh.Email

  alias ElixirQuest.Mailer

  @sender_signature System.get_env("SENDER_SIGNATURE")
  ...
  defp deliver(recipient, subject, body) do
    email =
      new()
      |> to(recipient)
      |> from({"Elixir Quest", @sender_signature})
      |> subject(subject)
      |> text_body(body)
