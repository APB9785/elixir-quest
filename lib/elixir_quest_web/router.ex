defmodule ElixirQuestWeb.Router do
  use ElixirQuestWeb, :router

  import ElixirQuestWeb.AccountAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {ElixirQuestWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ElixirQuestWeb.Telemetry
    end
  end
